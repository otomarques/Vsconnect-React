                    ...
                    <form className="cad_serv_formulario" action=""onSubmit={cadastrarServico} method='POST'>
                        <div className="cad_serv_box_input">
                            ...
                            <input
                                type="text"
                                id="titulo"
                                placeholder="Ex: E-commerce para pizzaria"onChange={(event) => setNome(event.target.value)}
                            />
                        </div>
                        <div className="cad_serv_box_input">
                            ...
                            <textarea
                                name=""
                                id="descricao"
                                placeholder="Digite aqui a descrição resumida do que você precisa:"onChange={(event) => setDescricao(event.target.value)}
                            ></textarea>
                        </div>
                        <div className="cad_serv_box_input">
                            ...
                            <input
                                ...
                                // onKeyUp={ }
                                maxLength={17}
                                placeholder="Digite o valor que deseja pagar:"onChange={(event) => setValor(event.target.value)}
                            />
                        </div>
